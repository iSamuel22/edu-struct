  ...
  try {
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        ['Carga horária presencial', data.identification.inPersonHours ? `${data.identification.inPersonHours}` : 'N/A'],
        ['Carga horária a distância', data.identification.distanceHours ? `${data.identification.distanceHours}` : 'N/A'],
        ['Carga horária de atividades teóricas', data.identification.theoreticalHours ? `${data.identification.theoreticalHours}` : 'N/A'],
        ['Carga horária de atividades práticas', data.identification.practicalHours ? `${data.identification.practicalHours}` : 'N/A'],
        ['Carga horária de atividades de extensão', data.identification.extensionHours ? `${data.identification.extensionHours}` : 'N/A'],
        ['Carga horária total', data.identification.totalHours ? `${data.identification.totalHours}` : 'N/A'],
        ['Carga horária/Aula Semanal', data.identification.weeklyHours ? `${data.identification.weeklyHours}` : '0h00min/ 0h/a'],
      ],
